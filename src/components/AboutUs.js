    ...
    <>
      <Container>
        ...
        <AboutContainer>
          ...
          <TextContainer>
            <p>
              Welcome to the Baltimore Corgi community! Established in 2014 as a
              Facebook group, we are dedicated to bringing together Corgi owners
              in the Baltimore area and surrounding counties. Our goal is to
              create a supportive and engaging environment that serves as a
              valuable resource for Corgi owners or owners-to-be to connect with
              each other, ask questions, share advice, and participate in local
