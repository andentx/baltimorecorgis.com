...
const AboutPage = () => {
  return (
    <>
      <Layout>
        <Container>
          <SectionTitle>Highlight Signup</SectionTitle>
          <Link to="https://docs.google.com/forms/d/e/1FAIpQLScuZM7H0AbcYEx2f4Nbyol46tobRUrzx5PXgQcy720ynd_RYw/viewform">
            Click to here go to Highlight Signup page
          </Link>
        </Container>
      </Layout>
    </>
